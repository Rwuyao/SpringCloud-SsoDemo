var grid={
     ...
     * @param n
     */
    generateGridByCount: function(n){
        if(!this.document){
     ...
     * @param style
     */
    setGridStyleByIndex: function(n, style){
     ...
     * @param gridArea
     */
    convertGridArea: function(gridArea){
